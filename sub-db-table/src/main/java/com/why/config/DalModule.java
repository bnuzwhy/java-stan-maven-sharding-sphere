...
/**
    ...
    public DataSource dataSource() throws SQLException {
        ...
        //TODO 根据ID分表  一共分为2张表
        shardingRuleConfig.setDefaultTableShardingStrategyConfig(new StandardShardingStrategyConfiguration("id", new com.oujiong.config.PreciseModuloShardingTableAlgorithm()));
    ...
    Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("ds0", com.oujiong.config.DataSourceUtil.createDataSource("ds0"));
        result.put("ds1", com.oujiong.config.DataSourceUtil.createDataSource("ds1"));
        return result;
    }
